                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                ...
                                {
                                    echo "<{$article['titleTag']}>{$article['title']}</{$article['titleTag']}>";
                                    echo "<p{$article['pTagAttribs']}>{$article['articleText']}</p>";
                                }
                                ...
                                $articles = [
                                    [
                                        "titleTag" => "h2",
                                        "title" => "Privacy",
                                        "pTagAttribs" => ' class="mb-g"',
                                        "articleText" => "Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
